...
A cross-platform JLPT study app (N5 MVP) with vocabulary, flashcards, quizzes, and spaced-repetition progress tracking backed by Supabase.
...
- **Commit as your GitHub identity, or Vercel will block the deploy.** Vercel verifies that
  ...
  ```
  git config user.email "301370773+TheresaYip-star@users.noreply.github.com"
  git config user.name "TheresaYip-star"
  ```
